            ...
            >
              <div className="relative aspect-square rounded-[2.5rem] overflow-hidden bg-[#fcfcfc] border border-zinc-100 transition-all duration-700 group-hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.1)] group-hover:-translate-y-2">
                ...
                <div className="absolute top-6 left-6 right-6 flex justify-between items-start z-20">
                  ...
                  <div className="flex flex-col gap-2 opacity-100 md:opacity-0 md:translate-y-[-10px] md:group-hover:translate-y-0 md:group-hover:opacity-100 transition-all duration-500">
                ...
                {/* Quick Buy CTA */}
                <div className="absolute bottom-6 left-6 right-6 z-30 opacity-100 translate-y-0 md:translate-y-12 md:opacity-0 md:group-hover:translate-y-0 md:group-hover:opacity-100 transition-all duration-500">
